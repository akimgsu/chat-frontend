...
const API_GATEWAY_ID = "12olqmb2j6"
const SOCKET_API_GATEWAY_ID = "8m3moscu4b"
class App extends Component {
  ...
  connectToWebScoket = () => {
    const address = `wss://${SOCKET_API_GATEWAY_ID}.execute-api.us-east-1.amazonaws.com/dev?user_id=test&room_id=test`
  ...
  componentDidMount = async () => {
    ...
    const result = await axios({
      method: 'GET',
      url: `https://${API_GATEWAY_ID}.execute-api.us-east-1.amazonaws.com/dev/chat`,
      params: {
        room_id: "test"
      }
    });
